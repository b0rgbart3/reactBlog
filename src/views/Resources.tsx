...
const books = [
  ...
  },
  {
    ...
    author: "Lyn Alden",
    image:
      "https://cdn.prod.website-files.com/64fee27528c4095c908b5078/66192f88571bebeb4974ac89_Broken%20_money_border-min.avif",
...
const STATIC_TYPES = ["Book", "Podcast", "Product", "Business"];

function pinFirst(types: string[], pinned: string | null): string[] {
  if (!pinned) return types;
  return [pinned, ...types.filter((t) => t !== pinned)];
}
...
export function Resources() {
  ...
  function handleTypeClick(type: string) {
    setPinnedType((prev) => (prev === type ? null : type));
  }

  function quickLinkClass(type: string) {
    return `quickLink${pinnedType === type ? " quickLink--active" : ""}`;
  }

  if (useDynamicMode) {
    const sortedTypes = pinFirst(distinctTypes, pinnedType);
    return (
      <div className="siteWrapper">
        ...
        <div className="basicContainer">
          ...
          <p>
            This is a short list of the resources in the bitcoin space that are
                  ...
                  .map((r) => (
                    <div key={r._id} className="bookCard">
                      <a href={r.linkURL} target="new">
                        ...
                        {r.description && (
                          <div className="bookDescription">{r.description}</div>
                        )}
                      </a>
                    </div>
                  ))}
  ...
  const sortedStaticTypes = pinFirst(STATIC_TYPES, pinnedType);
          ...
          if (type === "Podcast")
            return (
              <div key="Podcast">
                ...
                <ul>
                  <li>
                    <a href="https://www.fountain.fm/show/BMElezTqi1mcOc4PnwSH" target="new">
                  ...
                  <li>
                    <a href="https://www.youtube.com/watch?v=g2aE7hVKH1o&list=PLoB1eZWSVHVbHsHgaIIp0cy0MSDoz7uo0" target="new">
                  ...
                  <li>
                    <a href="https://www.youtube.com/@thebitcoinmatrixpodcast" target="new">
